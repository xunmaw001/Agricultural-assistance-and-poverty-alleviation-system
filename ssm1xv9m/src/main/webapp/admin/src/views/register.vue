  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">助农扶贫微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																								...
																								<!-- <div v-if="tableName=='nonghu'" class="input-group">
			   <div class="label">农户账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.nonghuzhanghao" class="input" type="text" placeholder="农户账号">
			   </div>
			 </div> -->
			<el-form-item label="农户账号" class="input" v-if="tableName=='nonghu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='nonghu'" class="input-group">
			   <div class="label">农户姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.nonghuxingming" class="input" type="text" placeholder="农户姓名">
			   </div>
			 </div> -->
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='nonghu'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='nonghu'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210308/ebad2b2b09fe4a12add1ed68d1ede24f.jpg");
		height: 100vh;
