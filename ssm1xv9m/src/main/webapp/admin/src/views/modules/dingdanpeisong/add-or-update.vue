  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发货日期" prop="fahuoriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fahuoriqi" label="发货日期" prop="fahuoriqi">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                    		if(json.nonghuzhanghao!=''&&json.nonghuzhanghao){
              		this.ruleForm.nonghuzhanghao = json.nonghuzhanghao
		}
                                  		if(json.nonghuxingming!=''&&json.nonghuxingming){
