  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" label="农户账号" prop="nonghuzhanghao">
              <el-input v-model="ruleForm.nonghuzhanghao" 
        ...
        <div v-else>
          <el-form-item class="input" label="农户姓名" prop="nonghuxingming">
              <el-input v-model="ruleForm.nonghuxingming" 
                placeholder="农户姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品评价" prop="shangpinpingjia">
          <el-input v-model="ruleForm.shangpinpingjia" 
              placeholder="商品评价" clearable  :readonly="ro.shangpinpingjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品评价" prop="shangpinpingjia">
              <el-input v-model="ruleForm.shangpinpingjia" 
                placeholder="商品评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品评分" prop="shangpinpingfen">
          <el-select v-model="ruleForm.shangpinpingfen" placeholder="请选择商品评分">
            <el-option
                v-for="(item,index) in shangpinpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="商品评分" prop="shangpinpingfen">
	      <el-input v-model="ruleForm.shangpinpingfen"
                placeholder="商品评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
