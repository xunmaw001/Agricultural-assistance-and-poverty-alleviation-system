<template>
  <div class="main-content">
		    ...
		    label="收货地址">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('dingdanxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('dingdanxinxi','发货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发货':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','发货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发货':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','发货') && contents.tableBtnIcon == 0" type="success" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发货':'' }}</el-button>
                                                <el-button v-if="isAuth('dingdanxinxi','商品评价') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="shangpinpingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'商品评价':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','商品评价') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="shangpinpingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'商品评价':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','商品评价') && contents.tableBtnIcon == 0" type="success" size="mini" @click="shangpinpingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'商品评价':'' }}</el-button>
                                                <el-button v-if="isAuth('dingdanxinxi','退货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="shangpintuihuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'退货':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','退货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="shangpintuihuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'退货':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','退货') && contents.tableBtnIcon == 0" type="success" size="mini" @click="shangpintuihuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'退货':'' }}</el-button>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
        ...
        <shangpintuihuo-cross-add-or-update v-if="shangpintuihuoCrossAddOrUpdateFlag" :parent="this" ref="shangpintuihuoCrossaddOrUpdate"></shangpintuihuo-cross-add-or-update>
...
import shangpintuihuoCrossAddOrUpdate from "../shangpintuihuo/add-or-update";
export default {
  data() {
    return {
                                                                                                                                                                                                                                                                                                      searchForm: {
      ...
      addOrUpdateFlag:false,
            ...
            shangpintuihuoCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
        ...
        shangpintuihuoCrossAddOrUpdate,
          },
  methods: {
    contentStyleChange() {
    ...
    contentPageStyleChange(){
      ...
      this.$nextTick(() => {
        ...
        shangpintuihuoCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.shangpintuihuoCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','dingdanxinxi');
      this.$nextTick(() => {
        this.$refs.shangpintuihuoCrossaddOrUpdate.init(row.id,type);
      });
    },
                payHandler(row){
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            url: `value/dingdanxinxi/shangpinmingcheng/zongjine`,
            method: "get"
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
